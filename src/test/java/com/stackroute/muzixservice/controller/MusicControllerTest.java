...
public class MusicControllerTest {
    ...
    public void setUp() {
        ...
        music = new Music();
        music.setId(1);
        music.setTrackName("suno na sangemarmar");
        music.setTrackComments("Good song");
        list=new ArrayList<>();
        list.add(music);
    }
    ...
    public void deleteTrack() throws Exception{
        when(musicService.deleteTracks(music.getId())).thenReturn(music);
        mockMvc.perform(MockMvcRequestBuilders.delete("/api/v1/music/1")
                .contentType(MediaType.APPLICATION_JSON).content(asJsonString(music)))
                .andExpect(MockMvcResultMatchers.status().isCreated())
                .andDo(MockMvcResultHandlers.print());
    }
    ...
    public void updateTrackTest() throws Exception{
        when(musicService.updateTrack(music,music.getId())).thenReturn(music);
